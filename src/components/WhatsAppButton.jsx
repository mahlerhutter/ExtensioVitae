...
export default function WhatsAppButton() {
    ...
    return (
        <button
            onClick={handleClick}
            className="w-full bg-[#25D366] hover:bg-[#20bd5a] text-white py-3 px-4 rounded-xl flex items-center justify-center gap-3 transition-transform active:scale-95 shadow-lg shadow-[#25cf65]/20"
        >
            <svg
                viewBox="0 0 24 24"
                fill="currentColor"
