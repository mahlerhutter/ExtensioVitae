...
const versions = [
    {
        ...
        features: [
            'Smart Log: AI Activity Tracking (OpenAI GPT-4o-mini)',
            'Natural Language Input → Pillar Classification',
            'Header Quick-Input: "⚡ Neue Aktivität tracken"',
            'Dashboard "Getrackte Aktivitäten" Section',
            'Dual-Pillar Support (z.B. Wandern + Freunde)',
            'Edge Function mit Input Validation & Clamping',
            'activity_logs Table mit RLS',
